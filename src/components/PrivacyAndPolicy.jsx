...
const PrivacyPolicy = () => {
  return (
    <div className="container py-5">
      <h2 className="mb-4 text-center">Privacy Policy – SIMCURARX Rider App</h2>

      <p>
        At SIMCURARX, we respect your privacy and are committed to safeguarding your personal information. This Privacy Policy outlines how we collect, use, store, and protect your data when you register and use the SIMCURARX Rider App.
      </p>
      ...
      <p>
        All uploaded documents (License, etc.) are stored in encrypted form on secure servers. Access is restricted to authorized personnel only. Sensitive data like bank account numbers are masked in the app interface.
      </p>
      ...
      <p>
        We may update this Privacy Policy periodically. Continued use of the SIMCURARX Rider App constitutes your acceptance of any changes.
      </p>
    </div>
  );
};
